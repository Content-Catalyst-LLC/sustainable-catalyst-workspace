...
def profile() -> dict[str, Any]:
    return {
        ...
        "migrationLineage": "034_research_session_object_binding_runtime.sql",
        "rollbackBaseline": "3.2.0",
        ...
        "requiredSubsystems": [
            ...
            "platform-core-v3-unified-research-runtime", "research-session-object-bindings"
        ],
    }
