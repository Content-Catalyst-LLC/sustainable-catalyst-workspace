...
# v3.11.0 Documentary Evidence, Testimony & Statement Analysis Workspace
class InvestigationDocumentHead(Base):
    __tablename__ = "workspace_investigation_document_heads"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    ...
    authority: Mapped[str] = mapped_column(String(500), nullable=False, default="")
...
class InvestigationDocumentRevision(Base):
    __tablename__ = "workspace_investigation_document_revisions"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    document_id: Mapped[str] = mapped_column(String(160), primary_key=True)
    revision: Mapped[int] = mapped_column(Integer, primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
...
class InvestigationDocumentExcerpt(Base):
    __tablename__ = "workspace_investigation_document_excerpts"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    excerpt_id: Mapped[str] = mapped_column(String(160), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
...
class InvestigationTestimonyHead(Base):
    __tablename__ = "workspace_investigation_testimony_heads"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    testimony_id: Mapped[str] = mapped_column(String(160), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
    testimony_type: Mapped[str] = mapped_column(String(48), nullable=False)
    title: Mapped[str] = mapped_column(String(1000), nullable=False)
    text: Mapped[str] = mapped_column(Text, nullable=False)
    speaker_entity_id: Mapped[str] = mapped_column(String(160), nullable=False, default="")
    source_document_id: Mapped[str] = mapped_column(String(160), nullable=False, default="")
    source_ref: Mapped[str] = mapped_column(String(2000), nullable=False, default="")
    source_fingerprint: Mapped[str] = mapped_column(String(128), nullable=False)
    occurred_at: Mapped[str] = mapped_column(String(64), nullable=False, default="")
    review_state: Mapped[str] = mapped_column(String(32), nullable=False, default="open")
    revision: Mapped[int] = mapped_column(Integer, nullable=False, default=1)
    testimony_fingerprint: Mapped[str] = mapped_column(String(64), nullable=False)
    metadata_json: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=utcnow)
    updated_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=utcnow, onupdate=utcnow)

class InvestigationTestimonyRevision(Base):
    __tablename__ = "workspace_investigation_testimony_revisions"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    testimony_id: Mapped[str] = mapped_column(String(160), primary_key=True)
    revision: Mapped[int] = mapped_column(Integer, primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
...
class InvestigationDocumentaryContextLink(Base):
    __tablename__ = "workspace_investigation_documentary_context_links"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    link_id: Mapped[str] = mapped_column(String(160), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
...
class InvestigationTestimonyRelation(Base):
    __tablename__ = "workspace_investigation_testimony_relations"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    relation_id: Mapped[str] = mapped_column(String(160), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
    from_testimony_id: Mapped[str] = mapped_column(String(160), nullable=False)
    to_testimony_id: Mapped[str] = mapped_column(String(160), nullable=False)
    relation: Mapped[str] = mapped_column(String(64), nullable=False)
    note: Mapped[str] = mapped_column(Text, nullable=False, default="")
    relation_fingerprint: Mapped[str] = mapped_column(String(64), nullable=False)
    metadata_json: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict)
...
class InvestigationDocumentarySnapshot(Base):
    __tablename__ = "workspace_investigation_documentary_snapshots"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    ...
    excerpt_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    testimony_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    context_link_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    testimony_relation_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
...
# v3.13.0 Media Artifact, Image, Video & Derivative Provenance Workspace
class InvestigationMediaArtifactHead(Base):
    __tablename__ = "workspace_investigation_media_artifact_heads"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    artifact_id: Mapped[str] = mapped_column(String(160), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
    ...
    source_ref: Mapped[str] = mapped_column(String(2000), nullable=False)
    source_fingerprint: Mapped[str] = mapped_column(String(128), nullable=False)
    content_hash_algorithm: Mapped[str] = mapped_column(String(32), nullable=False, default="sha256")
    ...
    original_filename: Mapped[str] = mapped_column(String(1000), nullable=False, default="")
    captured_at: Mapped[str] = mapped_column(String(64), nullable=False, default="")
    duration_seconds: Mapped[str] = mapped_column(String(64), nullable=False, default="")
    review_state: Mapped[str] = mapped_column(String(32), nullable=False, default="open")
    revision: Mapped[int] = mapped_column(Integer, nullable=False, default=1)
...
class InvestigationMediaArtifactRevision(Base):
    __tablename__ = "workspace_investigation_media_artifact_revisions"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    artifact_id: Mapped[str] = mapped_column(String(160), primary_key=True)
    revision: Mapped[int] = mapped_column(Integer, primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
...
class InvestigationMediaLocator(Base):
    __tablename__ = "workspace_investigation_media_locators"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    locator_id: Mapped[str] = mapped_column(String(96), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
    artifact_id: Mapped[str] = mapped_column(String(160), nullable=False)
    locator_type: Mapped[str] = mapped_column(String(40), nullable=False)
...
class InvestigationMediaDerivative(Base):
    __tablename__ = "workspace_investigation_media_derivatives"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    derivative_id: Mapped[str] = mapped_column(String(96), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
    parent_artifact_id: Mapped[str] = mapped_column(String(160), nullable=False)
    child_artifact_id: Mapped[str] = mapped_column(String(160), nullable=False)
    transformation_type: Mapped[str] = mapped_column(String(64), nullable=False)
    parameters_json: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict)
    tool_ref: Mapped[str] = mapped_column(String(1000), nullable=False, default="")
    operation_ref: Mapped[str] = mapped_column(String(1000), nullable=False, default="")
    source_fingerprint: Mapped[str] = mapped_column(String(128), nullable=False, default="")
    derivative_fingerprint: Mapped[str] = mapped_column(String(64), nullable=False)
    metadata_json: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=utcnow)

class InvestigationMediaContextLink(Base):
    __tablename__ = "workspace_investigation_media_context_links"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    link_id: Mapped[str] = mapped_column(String(96), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
    artifact_id: Mapped[str] = mapped_column(String(160), nullable=False)
    ...
    target_ref: Mapped[str] = mapped_column(String(2000), nullable=False)
    relation: Mapped[str] = mapped_column(String(64), nullable=False)
    locator_id: Mapped[str] = mapped_column(String(96), nullable=False, default="")
    source_fingerprint: Mapped[str] = mapped_column(String(128), nullable=False, default="")
    note: Mapped[str] = mapped_column(Text, nullable=False, default="")
    link_fingerprint: Mapped[str] = mapped_column(String(64), nullable=False)
    metadata_json: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict)
...
class InvestigationMediaRelation(Base):
    __tablename__ = "workspace_investigation_media_relations"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    relation_id: Mapped[str] = mapped_column(String(96), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
    from_artifact_id: Mapped[str] = mapped_column(String(160), nullable=False)
    to_artifact_id: Mapped[str] = mapped_column(String(160), nullable=False)
    relation: Mapped[str] = mapped_column(String(64), nullable=False)
    source_ref: Mapped[str] = mapped_column(String(2000), nullable=False, default="")
    source_fingerprint: Mapped[str] = mapped_column(String(128), nullable=False, default="")
    note: Mapped[str] = mapped_column(Text, nullable=False, default="")
...
class InvestigationMediaSnapshot(Base):
    __tablename__ = "workspace_investigation_media_snapshots"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    snapshot_id: Mapped[str] = mapped_column(String(96), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
    graph_fingerprint: Mapped[str] = mapped_column(String(64), nullable=False)
    ...
    snapshot_fingerprint: Mapped[str] = mapped_column(String(64), nullable=False)
    artifact_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    locator_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    derivative_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    context_link_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    relation_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    issue_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    context_json: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict)
...
# v3.14.0 Source Reliability, Provenance & Evidence Integrity Workspace
class InvestigationSourceHead(Base):
    __tablename__ = "workspace_investigation_source_heads"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    ...
    title: Mapped[str] = mapped_column(String(1000), nullable=False)
    source_ref: Mapped[str] = mapped_column(String(2000), nullable=False)
    publisher: Mapped[str] = mapped_column(String(1000), nullable=False, default="")
    published_at: Mapped[str] = mapped_column(String(64), nullable=False, default="")
    retrieved_at: Mapped[str] = mapped_column(String(64), nullable=False, default="")
...
class InvestigationSourceRevision(Base):
    __tablename__ = "workspace_investigation_source_revisions"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    source_id: Mapped[str] = mapped_column(String(160), primary_key=True)
    revision: Mapped[int] = mapped_column(Integer, primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
...
class InvestigationSourceProvenanceEvent(Base):
    __tablename__ = "workspace_investigation_source_provenance_events"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    event_id: Mapped[str] = mapped_column(String(96), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
    source_id: Mapped[str] = mapped_column(String(160), nullable=False)
    event_type: Mapped[str] = mapped_column(String(48), nullable=False)
    parent_ref: Mapped[str] = mapped_column(String(2000), nullable=False, default="")
    child_ref: Mapped[str] = mapped_column(String(2000), nullable=False, default="")
    occurred_at: Mapped[str] = mapped_column(String(64), nullable=False, default="")
    actor_ref: Mapped[str] = mapped_column(String(1000), nullable=False, default="")
    operation_ref: Mapped[str] = mapped_column(String(1000), nullable=False, default="")
    source_fingerprint: Mapped[str] = mapped_column(String(128), nullable=False, default="")
    event_fingerprint: Mapped[str] = mapped_column(String(64), nullable=False)
    metadata_json: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict)
...
class InvestigationSourceCustodyEvent(Base):
    __tablename__ = "workspace_investigation_source_custody_events"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    custody_id: Mapped[str] = mapped_column(String(96), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
    source_id: Mapped[str] = mapped_column(String(160), nullable=False)
    action: Mapped[str] = mapped_column(String(48), nullable=False)
    custodian_ref: Mapped[str] = mapped_column(String(1000), nullable=False)
    occurred_at: Mapped[str] = mapped_column(String(64), nullable=False, default="")
    location_ref: Mapped[str] = mapped_column(String(1000), nullable=False, default="")
    receipt_ref: Mapped[str] = mapped_column(String(2000), nullable=False, default="")
    source_fingerprint: Mapped[str] = mapped_column(String(128), nullable=False, default="")
    custody_fingerprint: Mapped[str] = mapped_column(String(64), nullable=False)
    metadata_json: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=utcnow)

class InvestigationIntegrityAssertion(Base):
    __tablename__ = "workspace_investigation_integrity_assertions"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    assertion_id: Mapped[str] = mapped_column(String(96), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
    source_id: Mapped[str] = mapped_column(String(160), nullable=False)
    assertion_type: Mapped[str] = mapped_column(String(64), nullable=False)
    status: Mapped[str] = mapped_column(String(32), nullable=False)
    basis_ref: Mapped[str] = mapped_column(String(2000), nullable=False, default="")
    source_fingerprint: Mapped[str] = mapped_column(String(128), nullable=False, default="")
    note: Mapped[str] = mapped_column(Text, nullable=False, default="")
...
class InvestigationSourceEvidenceBinding(Base):
    __tablename__ = "workspace_investigation_source_evidence_bindings"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    binding_id: Mapped[str] = mapped_column(String(96), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
    source_id: Mapped[str] = mapped_column(String(160), nullable=False)
    ...
    target_ref: Mapped[str] = mapped_column(String(2000), nullable=False)
    relation: Mapped[str] = mapped_column(String(64), nullable=False)
    locator_ref: Mapped[str] = mapped_column(String(1000), nullable=False, default="")
    source_fingerprint: Mapped[str] = mapped_column(String(128), nullable=False, default="")
    note: Mapped[str] = mapped_column(Text, nullable=False, default="")
...
class InvestigationSourceIntegritySnapshot(Base):
    __tablename__ = "workspace_investigation_source_integrity_snapshots"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    snapshot_id: Mapped[str] = mapped_column(String(96), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
    graph_fingerprint: Mapped[str] = mapped_column(String(64), nullable=False)
    ...
    snapshot_fingerprint: Mapped[str] = mapped_column(String(64), nullable=False)
    source_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    provenance_event_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    custody_event_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
...
# v3.18.0 Causal Analysis & Alternative Explanation Workspace
class CausalQuestionHead(Base):
    __tablename__ = "workspace_causal_question_heads"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    question_id: Mapped[str] = mapped_column(String(160), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
    title: Mapped[str] = mapped_column(String(500), nullable=False)
    question_text: Mapped[str] = mapped_column(Text, nullable=False)
    estimand: Mapped[str] = mapped_column(String(500), nullable=False, default="")
    exposure_ref: Mapped[str] = mapped_column(String(1000), nullable=False, default="")
    outcome_ref: Mapped[str] = mapped_column(String(1000), nullable=False, default="")
    review_state: Mapped[str] = mapped_column(String(40), nullable=False, default="open")
    revision: Mapped[int] = mapped_column(Integer, nullable=False, default=1)
...
class CausalQuestionRevision(Base):
    __tablename__ = "workspace_causal_question_revisions"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    question_id: Mapped[str] = mapped_column(String(160), primary_key=True)
    revision: Mapped[int] = mapped_column(Integer, primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
...
class CausalStructureRecord(Base):
    __tablename__ = "workspace_causal_structures"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    structure_id: Mapped[str] = mapped_column(String(96), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
    question_id: Mapped[str] = mapped_column(String(160), nullable=False)
    title: Mapped[str] = mapped_column(String(500), nullable=False)
    structure_kind: Mapped[str] = mapped_column(String(80), nullable=False)
    variables_json: Mapped[list] = mapped_column(JSONB, nullable=False, default=list)
    edges_json: Mapped[list] = mapped_column(JSONB, nullable=False, default=list)
    graph_ref: Mapped[str] = mapped_column(String(2000), nullable=False, default="")
    graph_fingerprint: Mapped[str] = mapped_column(String(128), nullable=False, default="")
    structure_fingerprint: Mapped[str] = mapped_column(String(64), nullable=False)
    metadata_json: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=utcnow)

class AlternativeExplanationRecord(Base):
    __tablename__ = "workspace_alternative_explanations"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    explanation_id: Mapped[str] = mapped_column(String(96), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
    question_id: Mapped[str] = mapped_column(String(160), nullable=False)
    title: Mapped[str] = mapped_column(String(500), nullable=False)
    ...
    hypothesis_refs_json: Mapped[list] = mapped_column(JSONB, nullable=False, default=list)
    evidence_refs_json: Mapped[list] = mapped_column(JSONB, nullable=False, default=list)
    explanation_fingerprint: Mapped[str] = mapped_column(String(64), nullable=False)
    metadata_json: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=utcnow)

class CausalIdentificationAssumption(Base):
    __tablename__ = "workspace_causal_identification_assumptions"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    assumption_id: Mapped[str] = mapped_column(String(96), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
    question_id: Mapped[str] = mapped_column(String(160), nullable=False)
    assumption_type: Mapped[str] = mapped_column(String(120), nullable=False)
    statement: Mapped[str] = mapped_column(Text, nullable=False)
    rationale: Mapped[str] = mapped_column(Text, nullable=False, default="")
    status: Mapped[str] = mapped_column(String(40), nullable=False, default="asserted")
    evidence_refs_json: Mapped[list] = mapped_column(JSONB, nullable=False, default=list)
    assumption_fingerprint: Mapped[str] = mapped_column(String(64), nullable=False)
    metadata_json: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=utcnow)

class CausalAnalysisHandoff(Base):
    __tablename__ = "workspace_causal_analysis_handoffs"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    handoff_id: Mapped[str] = mapped_column(String(96), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
    question_id: Mapped[str] = mapped_column(String(160), nullable=False)
    ...
    destination_product: Mapped[str] = mapped_column(String(80), nullable=False)
    estimand: Mapped[str] = mapped_column(String(500), nullable=False, default="")
    treatment_ref: Mapped[str] = mapped_column(String(1000), nullable=False, default="")
    outcome_ref: Mapped[str] = mapped_column(String(1000), nullable=False, default="")
    adjustment_set_json: Mapped[list] = mapped_column(JSONB, nullable=False, default=list)
    configuration_json: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict)
    status: Mapped[str] = mapped_column(String(40), nullable=False, default="ready")
    handoff_fingerprint: Mapped[str] = mapped_column(String(64), nullable=False)
    external_handoff_ref: Mapped[str] = mapped_column(String(2000), nullable=False, default="")
    metadata_json: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=utcnow)

class CausalResultBinding(Base):
    __tablename__ = "workspace_causal_result_bindings"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    binding_id: Mapped[str] = mapped_column(String(96), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
    question_id: Mapped[str] = mapped_column(String(160), nullable=False)
    handoff_id: Mapped[str] = mapped_column(String(96), nullable=False, default="")
...
class CausalInvestigationSnapshot(Base):
    __tablename__ = "workspace_causal_investigation_snapshots"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    snapshot_id: Mapped[str] = mapped_column(String(96), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
    analysis_fingerprint: Mapped[str] = mapped_column(String(64), nullable=False)
    ...
    structure_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
...
# v3.19.0 Predictive Investigation & Scenario Modeling Workspace
class PredictiveScenarioHead(Base):
    __tablename__ = "workspace_predictive_scenario_heads"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    scenario_id: Mapped[str] = mapped_column(String(160), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
    title: Mapped[str] = mapped_column(String(500), nullable=False)
    description: Mapped[str] = mapped_column(Text, nullable=False, default="")
    scenario_kind: Mapped[str] = mapped_column(String(80), nullable=False, default="exploratory")
    horizon: Mapped[str] = mapped_column(String(500), nullable=False, default="")
    assumptions_json: Mapped[list] = mapped_column(JSONB, nullable=False, default=list)
    input_refs_json: Mapped[list] = mapped_column(JSONB, nullable=False, default=list)
    causal_question_refs_json: Mapped[list] = mapped_column(JSONB, nullable=False, default=list)
    uncertainty_assessment_refs_json: Mapped[list] = mapped_column(JSONB, nullable=False, default=list)
    review_state: Mapped[str] = mapped_column(String(40), nullable=False, default="open")
    revision: Mapped[int] = mapped_column(Integer, nullable=False, default=1)
    scenario_fingerprint: Mapped[str] = mapped_column(String(64), nullable=False)
    metadata_json: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict)
...
class PredictiveScenarioRevision(Base):
    __tablename__ = "workspace_predictive_scenario_revisions"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    scenario_id: Mapped[str] = mapped_column(String(160), primary_key=True)
    revision: Mapped[int] = mapped_column(Integer, primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
...
class PredictiveModelBinding(Base):
    __tablename__ = "workspace_predictive_model_bindings"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    binding_id: Mapped[str] = mapped_column(String(96), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
    ...
    model_ref: Mapped[str] = mapped_column(String(2000), nullable=False)
    model_fingerprint: Mapped[str] = mapped_column(String(128), nullable=False)
    training_data_refs_json: Mapped[list] = mapped_column(JSONB, nullable=False, default=list)
    feature_refs_json: Mapped[list] = mapped_column(JSONB, nullable=False, default=list)
    environment_ref: Mapped[str] = mapped_column(String(2000), nullable=False, default="")
    environment_fingerprint: Mapped[str] = mapped_column(String(128), nullable=False, default="")
    binding_fingerprint: Mapped[str] = mapped_column(String(64), nullable=False)
    metadata_json: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=utcnow)

class PredictiveForecastRequest(Base):
    __tablename__ = "workspace_predictive_forecast_requests"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    forecast_request_id: Mapped[str] = mapped_column(String(96), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
    scenario_id: Mapped[str] = mapped_column(String(160), nullable=False)
    model_binding_id: Mapped[str] = mapped_column(String(96), nullable=False, default="")
    forecast_kind: Mapped[str] = mapped_column(String(120), nullable=False)
    destination_product: Mapped[str] = mapped_column(String(80), nullable=False)
    target_ref: Mapped[str] = mapped_column(String(2000), nullable=False, default="")
    horizon: Mapped[str] = mapped_column(String(500), nullable=False, default="")
    configuration_json: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict)
    calibration_plan_json: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict)
    backtest_plan_json: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict)
    status: Mapped[str] = mapped_column(String(40), nullable=False, default="ready")
    forecast_request_fingerprint: Mapped[str] = mapped_column(String(64), nullable=False)
    external_handoff_ref: Mapped[str] = mapped_column(String(2000), nullable=False, default="")
    metadata_json: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=utcnow)

class PredictiveForecastResultBinding(Base):
    __tablename__ = "workspace_predictive_forecast_result_bindings"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    binding_id: Mapped[str] = mapped_column(String(96), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
    scenario_id: Mapped[str] = mapped_column(String(160), nullable=False)
    forecast_request_id: Mapped[str] = mapped_column(String(96), nullable=False, default="")
    result_kind: Mapped[str] = mapped_column(String(100), nullable=False)
    result_ref: Mapped[str] = mapped_column(String(2000), nullable=False)
    result_fingerprint: Mapped[str] = mapped_column(String(128), nullable=False)
    model_conditional: Mapped[bool] = mapped_column(nullable=False, default=True)
    calibration_ref: Mapped[str] = mapped_column(String(2000), nullable=False, default="")
    calibration_fingerprint: Mapped[str] = mapped_column(String(128), nullable=False, default="")
    backtest_ref: Mapped[str] = mapped_column(String(2000), nullable=False, default="")
    backtest_fingerprint: Mapped[str] = mapped_column(String(128), nullable=False, default="")
    note: Mapped[str] = mapped_column(Text, nullable=False, default="")
    binding_fingerprint: Mapped[str] = mapped_column(String(64), nullable=False)
    metadata_json: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=utcnow)

class PredictiveScenarioComparison(Base):
    __tablename__ = "workspace_predictive_scenario_comparisons"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    ...
    scenario_ids_json: Mapped[list] = mapped_column(JSONB, nullable=False, default=list)
...
class PredictiveInvestigationSnapshot(Base):
    __tablename__ = "workspace_predictive_investigation_snapshots"
    user_key: Mapped[str] = mapped_column(String(128), primary_key=True)
    snapshot_id: Mapped[str] = mapped_column(String(96), primary_key=True)
    project_id: Mapped[str] = mapped_column(String(160), nullable=False)
    manifest_fingerprint: Mapped[str] = mapped_column(String(64), nullable=False)
    ...
    snapshot_fingerprint: Mapped[str] = mapped_column(String(64), nullable=False)
    scenario_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    model_binding_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    forecast_request_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    result_binding_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
