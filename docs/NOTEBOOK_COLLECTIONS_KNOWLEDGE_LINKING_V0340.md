# Notebook Collections & Knowledge Linking
...
- Corrects the public Notebook REST contract so its advertised schemas match the runtime Notebook v3/v2 model.
...
- Project REST contract now advertises Project v15, Project Export v15, and Notebook Workspace v3.
- Manual account backup and explicit sync accept current Project v15 plus supported legacy Project v14/v13/v12/v11 payloads.
- v0.34 asset handles are versioned consistently to avoid stale-cache ambiguity during rollout.
