...
class ButtonSystemControlAlignmentContract(unittest.TestCase):
    def test_release_identity_and_schema_freeze(self):
        ...
        self.assertIn("PREVIOUS_RELEASE = '2.0.0'",dep); self.assertIn('workspace-v2.0.1.css',dep); self.assertIn('workspace-v2.0.1.js',dep)
    ...
    def test_css_repairs_pdf_observed_controls(self):
        ...
        self.assertIn('data-release-stage="button-system-repair"',php)
