...
class HistoricalGAReadinessContractTests(unittest.TestCase):
 ...
 def test_current_advances(self):
  main=(R/'wordpress/sustainable-catalyst-workspace/sustainable-catalyst-workspace.php').read_text();self.assertIn('Version: 1.8.0',main);self.assertTrue((R/'release-manifest-v1.0.1.json').exists())
