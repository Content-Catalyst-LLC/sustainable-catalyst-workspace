...
class NotebookCollectionsKnowledgeLinkingContract(unittest.TestCase):
    ...
    def test_06_runtime_helper(self):
        for token in ('createCollection','addCollectionItem','createLink','backlinksForRef','findBlockLocation','refExists','sc-workspace-notebook-workspace/6.0'):
    ...
    def test_09_rest_contract(self):
        self.assertIn("'notebook_workspace_schema' => 'sc-workspace-notebook-workspace/6.0'",PHP)
