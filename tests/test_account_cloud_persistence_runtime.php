...
$project=array('schema'=>'sc-workspace-project/11.0','id'=>'scwp-demo','title'=>'Demo','updatedAt'=>'2026-08-09T00:00:00Z','objects'=>array(array('id'=>'scwo-1','schema'=>'sc-workspace-object/1.0','title'=>'Evidence')));
...
$res=$w->cloud_project_store(new Req($payload)); ok(is_array($res)&&$res['ok']===true,'backup stored'); ok(strlen($res['item']['fingerprint'])===64,'sha256 fingerprint');
...
echo "PASS - v0.21.0 account cloud persistence runtime\n";
