...
assert.strictEqual(ws.schema,'sc-workspace-notebook-workspace/8.0');assert.deepStrictEqual(ws.assistances,[]);
...
const exp=nb.exportNotebook(ws.notebooks[0],{id:'p1',title:'Project'},'0.37.0',ws);assert.strictEqual(exp.schema,'sc-workspace-notebook-export/8.0');assert.strictEqual(exp.assistances.length,1);assert.strictEqual(exp.governance.groundedAssistanceCitationsRequired,true);
