...
const root={dataset:{version:'0.31.0',storageVersion:'27',projectSchema:'sc-workspace-project/12.0',releaseStage:'public-beta'},querySelectorAll:()=>new Array(42)};
const diag=h.diagnostic(root,env);
assert.strictEqual(diag.deployment.workspaceVersion,'0.31.0');
