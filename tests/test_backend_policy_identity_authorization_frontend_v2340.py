...
MAIN=(WP/'assets/js/workspace-v2.34.0.js').read_text()
TYPED=(WP/'assets/js/sc-workspace-typed-client-v2340.js').read_text()
...
def test_release_identity_and_working_interaction_lineage_preserved():
    ...
    assert "const WORKSPACE_RELEASE = '2.34.0';" in MAIN
...
def test_generated_typed_client_is_v2340_and_has_34_endpoints():
    generated=(ROOT/'frontend/typed-client/src/00-generated-contracts.ts').read_text()
    assert "SCW_TYPED_CONTRACT_VERSION = '2.34.0'" in generated
    assert generated.count("path: '/v1/") == 34
