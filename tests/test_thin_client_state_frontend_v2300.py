...
MAIN=(WP/'assets/js/workspace-v2.32.0.js').read_text()
TYPED=(WP/'assets/js/sc-workspace-typed-client-v2320.js').read_text()
...
def test_release_identity_and_working_interaction_runtime_are_preserved():
    ...
    assert 'workspace-v2.32.0.js' in PHP and 'workspace-v2.32.0.css' in PHP
