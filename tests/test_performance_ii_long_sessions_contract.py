...
CSS=(ROOT/'wordpress/sustainable-catalyst-workspace/assets/css/workspace-v2.0.1.css').read_text()
class PerformanceII(unittest.TestCase):
 ...
 def test_03_contract_and_assets(self):
  ...
  self.assertIn("wp_localize_script('sc-workspace-v201'",PHP)
 ...
 def test_10_registry_history(self):
  ...
  self.assertIn("BACKUP_KEY = 'sc_workspace_registry_backup_v201'",REGPHP); self.assertIn('LEGACY_PENDING_KEY_V0670',REGPHP)
