...
class ProjectDiffChangeReviewContract(unittest.TestCase):
  ...
  def test_schema_stable(self): self.assertEqual(MAN['storage_schema_version'],30); self.assertEqual(MAN['project_schema'],'sc-workspace-project/15.0'); self.assertIn('const STORAGE_VERSION = 30;',JS)
