...
class ProjectDiffChangeReviewContract(unittest.TestCase):
  ...
  def test_schema_stable(self): self.assertEqual(MAN['storage_schema_version'],32); self.assertEqual(MAN['project_schema'],'sc-workspace-project/17.0'); self.assertIn('const STORAGE_VERSION = 32;',JS)
