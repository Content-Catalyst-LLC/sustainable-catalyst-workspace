...
class ProjectDiffChangeReviewContract(unittest.TestCase):
  ...
  def test_schema_stable(self): self.assertEqual(MAN['storage_schema_version'],29); self.assertEqual(MAN['project_schema'],'sc-workspace-project/14.0'); self.assertIn('const STORAGE_VERSION = 29;',JS)
