...
class ProjectDiffChangeReviewContract(unittest.TestCase):
  ...
  def test_schema_stable(self): self.assertEqual(MAN['storage_schema_version'],34); self.assertEqual(MAN['project_schema'],'sc-workspace-project/19.0'); self.assertIn('const STORAGE_VERSION = 34;',JS)
