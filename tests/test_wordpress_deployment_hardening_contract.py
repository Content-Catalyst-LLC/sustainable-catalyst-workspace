...
class DeploymentHardeningContract(unittest.TestCase):
 def test_01_lineage(self): self.assertEqual((MAN.get('version'),MAN.get('previous_version'),MAN.get('release_name')),('0.81.0','0.80.0','WordPress & Deployment Hardening')); self.assertIn('Version: 1.15.0',MAIN)
 ...
 def test_06_current_assets(self): self.assertIn("'sc-workspace-v1150'",PHP); self.assertIn('workspace-v1.15.0.js',PHP); self.assertIn('workspace-v1.15.0.css',PHP); self.assertNotIn("'sc-workspace-v0800'",PHP)
