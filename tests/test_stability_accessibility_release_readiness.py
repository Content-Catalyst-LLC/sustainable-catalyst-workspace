...
class StabilityAccessibilityReleaseReadiness(unittest.TestCase):
    ...
    def test_registry_lineage_advances_with_safe_actions_storage_migration(self):
        self.assertIn("BACKUP_KEY = 'sc_workspace_registry_backup_v1120'",REG)
        self.assertIn("PENDING_KEY = 'sc_workspace_registry_pending_v1120'",REG)
        ...
        self.assertIn("'previous_version' => '1.11.0'",REG)
