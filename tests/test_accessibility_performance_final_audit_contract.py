...
class AccessibilityPerformanceFinalAuditContract(unittest.TestCase):
 def test_01_lineage(self): self.assertEqual((MAN['version'],MAN['previous_version'],MAN['release_name']),('0.78.0','0.77.0','Accessibility & Performance Final Audit')); self.assertIn('Version: 1.13.0',MAIN)
