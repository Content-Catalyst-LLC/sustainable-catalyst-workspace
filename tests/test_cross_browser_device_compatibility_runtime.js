...
const report=C.report('0.63.0',C.capability(modern),C.assess(C.capability(modern)));assert.strictEqual(report.privacy.rawUserAgentIncluded,false);assert.strictEqual(report.privacy.deviceIdentifierIncluded,false);assert.strictEqual(report.governance.userAgentUsedForDisplayLabelOnly,true);
...
console.log('PASS - Workspace v0.63.0 Cross-Browser & Device Compatibility runtime');
