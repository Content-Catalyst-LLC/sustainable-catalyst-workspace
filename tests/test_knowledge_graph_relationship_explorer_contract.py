...
class KnowledgeGraphRelationshipExplorer(unittest.TestCase):
 ...
 def test_07_preserved_under_current(self): self.assertIn('Version: 1.13.0',MAIN);self.assertTrue((R/'wordpress/sustainable-catalyst-workspace/assets/js/sc-workspace-relationship-explorer-v2.js').exists())
