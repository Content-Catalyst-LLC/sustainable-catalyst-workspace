...
class FocusedApplicationShellContract(unittest.TestCase):
    ...
    def test_plugin_version(self):
        ...
        self.assertIn("define('SC_WORKSPACE_VERSION', '0.64.0');", MAIN)

    def test_current_assets(self):
        self.assertIn('assets/css/workspace-v0.64.0.css', PHP)
        self.assertIn('assets/js/workspace-v0.64.0.js', PHP)
    ...
    def test_registry_lineage(self):
        ...
        self.assertEqual(REG['public_version'], '0.64.0')
        self.assertEqual(REG['previous_version'], '0.63.0')
