...
CSS = (ROOT / 'wordpress/sustainable-catalyst-workspace/assets/css/workspace-v0.82.1.css').read_text()
...
class FocusedApplicationShellContract(unittest.TestCase):
    ...
    def test_plugin_version(self):
        ...
        self.assertIn("define('SC_WORKSPACE_VERSION', '0.82.1');", MAIN)

    def test_current_assets(self):
        self.assertIn('assets/css/workspace-v0.82.1.css', PHP)
        self.assertIn('assets/js/workspace-v0.82.1.js', PHP)
