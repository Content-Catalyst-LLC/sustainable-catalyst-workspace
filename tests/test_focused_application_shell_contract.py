...
class FocusedApplicationShellContract(unittest.TestCase):
    ...
    def test_plugin_version(self):
        ...
        self.assertIn("define('SC_WORKSPACE_VERSION', '1.11.0');", MAIN)

    def test_current_assets(self):
        self.assertIn('assets/css/workspace-v1.11.0.css', PHP)
        self.assertIn('assets/js/workspace-v1.11.0.js', PHP)
