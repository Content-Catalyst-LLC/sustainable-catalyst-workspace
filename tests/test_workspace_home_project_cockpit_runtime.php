...
if(strpos($main,'Version: 1.9.0')===false||strpos($class,'sc-workspace-home-project-cockpit-contract/1.0')===false||strpos($workspace,'/workspace-home-contract')===false||strpos($workspace,'data-scw-project-cockpit')===false){fwrite(STDERR,"FAIL - v1.1.0 home contract/runtime markers missing
