...
class FirstRunOnboardingProjectCreationContract(unittest.TestCase):
    ...
    def test_wordpress_surface_route_and_current_assets(self):
        ...
        self.assertIn("SC_WORKSPACE_VERSION', '2.0.2",MAIN)
        ...
        self.assertIn("'sc-workspace-v202'",PHP)
        self.assertIn('workspace-v2.0.2.js',PHP)
        self.assertIn('workspace-v2.0.2.css',PHP)
    ...
    def test_registry_history_docs_and_schemas(self):
        ...
        self.assertIn("BACKUP_KEY = 'sc_workspace_registry_backup_v202'",REGPHP)
        self.assertIn("PENDING_KEY = 'sc_workspace_registry_pending_v202'",REGPHP)
