...
class FirstRunOnboardingProjectCreationContract(unittest.TestCase):
    ...
    def test_wordpress_surface_route_and_current_assets(self):
        ...
        self.assertIn("SC_WORKSPACE_VERSION', '1.15.0",MAIN)
        ...
        self.assertIn("'sc-workspace-v1150'",PHP)
        self.assertIn('workspace-v1.15.0.js',PHP)
        self.assertIn('workspace-v1.15.0.css',PHP)
    ...
    def test_registry_history_docs_and_schemas(self):
        ...
        self.assertIn("BACKUP_KEY = 'sc_workspace_registry_backup_v1150'",REGPHP)
        self.assertIn("PENDING_KEY = 'sc_workspace_registry_pending_v1150'",REGPHP)
