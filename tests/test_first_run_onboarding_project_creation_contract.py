...
class FirstRunOnboardingProjectCreationContract(unittest.TestCase):
    ...
    def test_wordpress_surface_route_and_current_assets(self):
        self.assertIn("Version: 0.72.0",MAIN)
        self.assertIn("SC_WORKSPACE_VERSION', '0.72.0",MAIN)
        ...
        self.assertIn("'sc-workspace-v0720'",PHP)
        self.assertIn('workspace-v0.72.0.js',PHP)
        self.assertIn('workspace-v0.72.0.css',PHP)
    ...
    def test_registry_history_docs_and_schemas(self):
        ...
        self.assertIn("BACKUP_KEY = 'sc_workspace_registry_backup_v0720'",REGPHP)
        self.assertIn("PENDING_KEY = 'sc_workspace_registry_pending_v0720'",REGPHP)
