...
class FirstRunOnboardingProjectCreationContract(unittest.TestCase):
    ...
    def test_wordpress_surface_route_and_current_assets(self):
        ...
        self.assertIn("SC_WORKSPACE_VERSION', '1.11.0",MAIN)
        ...
        self.assertIn("'sc-workspace-v1110'",PHP)
        self.assertIn('workspace-v1.11.0.js',PHP)
        self.assertIn('workspace-v1.11.0.css',PHP)
