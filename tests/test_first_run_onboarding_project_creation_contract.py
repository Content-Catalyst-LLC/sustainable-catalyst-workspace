...
class FirstRunOnboardingProjectCreationContract(unittest.TestCase):
    ...
    def test_wordpress_surface_route_and_current_assets(self):
        ...
        self.assertIn("SC_WORKSPACE_VERSION', '2.0.1",MAIN)
        ...
        self.assertIn("'sc-workspace-v201'",PHP)
        self.assertIn('workspace-v2.0.1.js',PHP)
        self.assertIn('workspace-v2.0.1.css',PHP)
