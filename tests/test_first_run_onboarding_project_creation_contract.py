...
class FirstRunOnboardingProjectCreationContract(unittest.TestCase):
    ...
    def test_wordpress_surface_route_and_current_assets(self):
        ...
        self.assertIn("'sc-workspace-v160'",PHP)
        self.assertIn('workspace-v1.6.0.js',PHP)
        self.assertIn('workspace-v1.6.0.css',PHP)
    ...
    def test_registry_history_docs_and_schemas(self):
        ...
        self.assertIn("PENDING_KEY = 'sc_workspace_registry_pending_v160'",REGPHP)
