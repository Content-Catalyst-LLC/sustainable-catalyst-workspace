...
class FirstRunOnboardingProjectCreationContract(unittest.TestCase):
    ...
    def test_wordpress_surface_route_and_current_assets(self):
        ...
        self.assertIn("SC_WORKSPACE_VERSION', '0.81.0",MAIN)
        ...
        self.assertIn("'sc-workspace-v0810'",PHP)
        self.assertIn('workspace-v0.81.0.js',PHP)
        self.assertIn('workspace-v0.81.0.css',PHP)
