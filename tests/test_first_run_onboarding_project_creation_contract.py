...
APP=(R/'wordpress/sustainable-catalyst-workspace/assets/js/workspace-v0.71.0.js').read_text()
HELP=(R/'wordpress/sustainable-catalyst-workspace/assets/js/sc-workspace-first-run-onboarding-v1.js').read_text()
CSS=(R/'wordpress/sustainable-catalyst-workspace/assets/css/workspace-v0.71.0.css').read_text()
...
class FirstRunOnboardingProjectCreationContract(unittest.TestCase):
    ...
    def test_wordpress_surface_route_and_current_assets(self):
        self.assertIn("Version: 0.71.0",MAIN)
        self.assertIn("SC_WORKSPACE_VERSION', '0.71.0",MAIN)
        ...
        self.assertIn("'sc-workspace-v0710'",PHP)
        self.assertIn('workspace-v0.71.0.js',PHP)
        self.assertIn('workspace-v0.71.0.css',PHP)
    ...
    def test_registry_history_docs_and_schemas(self):
        ...
        self.assertIn("BACKUP_KEY = 'sc_workspace_registry_backup_v0710'",REGPHP)
        self.assertIn("PENDING_KEY = 'sc_workspace_registry_pending_v0710'",REGPHP)
