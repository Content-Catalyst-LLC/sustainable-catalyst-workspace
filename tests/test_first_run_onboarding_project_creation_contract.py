...
class FirstRunOnboardingProjectCreationContract(unittest.TestCase):
    ...
    def test_wordpress_surface_route_and_current_assets(self):
        ...
        self.assertIn("SC_WORKSPACE_VERSION', '0.77.0",MAIN)
        ...
        self.assertIn("'sc-workspace-v0770'",PHP)
        self.assertIn('workspace-v0.77.0.js',PHP)
        self.assertIn('workspace-v0.77.0.css',PHP)
