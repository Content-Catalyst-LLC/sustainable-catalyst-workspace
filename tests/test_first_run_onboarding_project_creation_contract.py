...
class FirstRunOnboardingProjectCreationContract(unittest.TestCase):
    ...
    def test_wordpress_surface_route_and_current_assets(self):
        ...
        self.assertIn("SC_WORKSPACE_VERSION', '1.13.0",MAIN)
        ...
        self.assertIn("'sc-workspace-v1130'",PHP)
        self.assertIn('workspace-v1.13.0.js',PHP)
        self.assertIn('workspace-v1.13.0.css',PHP)
    ...
    def test_registry_history_docs_and_schemas(self):
        ...
        self.assertIn("PENDING_KEY = 'sc_workspace_registry_pending_v1130'",REGPHP)
