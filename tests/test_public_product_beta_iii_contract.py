...
APP=(R/'wordpress/sustainable-catalyst-workspace/assets/js/workspace-v0.70.0.js').read_text()
CSS=(R/'wordpress/sustainable-catalyst-workspace/assets/css/workspace-v0.70.0.css').read_text()
