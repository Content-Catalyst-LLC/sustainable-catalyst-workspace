...
class T(unittest.TestCase):
 ...
 def test_14_registry_history(self): self.assertEqual((REG['public_version'],REG['previous_version']),('0.65.0','0.64.1'));self.assertIn("BACKUP_KEY = 'sc_workspace_registry_backup_v0650'",REGPHP);self.assertIn('LEGACY_PENDING_KEY_V0620',REGPHP);self.assertTrue((ROOT/'history/release-manifest-v0.62.0.json').exists())
