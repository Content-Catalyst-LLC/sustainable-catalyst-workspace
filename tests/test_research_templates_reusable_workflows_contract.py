...
class V049Templates(unittest.TestCase):
 def test_01_lineage(self): self.assertEqual((MAN['version'],MAN['previous_version']),('0.66.0','0.65.0')); self.assertIn('Version: 0.79.0',MAIN); self.assertEqual((FEATURE['version'],FEATURE['release_name']),('0.49.0','Research Templates & Reusable Workflows'))
