...
class SecurityPrivacyAuditIIContract(unittest.TestCase):
 def test_01_lineage(self): self.assertEqual((MAN['version'],MAN['previous_version'],MAN['release_name']),('0.77.0','0.76.0','Security & Privacy Audit II')); self.assertIn('Version: 0.82.1',MAIN)
