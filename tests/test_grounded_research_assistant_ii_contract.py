...
class GroundedResearchAssistantII(unittest.TestCase):
 def test_01_lineage(self): self.assertEqual((MAN['version'],MAN['previous_version'],MAN['release_name']),('0.66.0','0.65.0','Import, Export & Backward-Compatibility Hardening')); self.assertIn('Version: 1.8.0',MAIN); self.assertEqual(PREV['release_name'],'Workspace Experience Consolidation')
