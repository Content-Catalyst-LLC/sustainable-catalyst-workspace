...
class GroundedResearchAssistantII(unittest.TestCase):
 def test_01_lineage(self): self.assertEqual((MAN['version'],MAN['previous_version'],MAN['release_name']),('0.58.0','0.57.0','Scale, Performance & Large-Project Hardening')); self.assertIn('Version: 0.58.0',MAIN); self.assertEqual(PREV['release_name'],'Workspace Experience Consolidation')
