...
class GroundedResearchAssistantII(unittest.TestCase):
 def test_01_lineage(self): self.assertEqual((MAN['version'],MAN['previous_version'],MAN['release_name']),('0.51.0','0.50.0','Grounded Research Assistant II')); self.assertIn('Version: 0.51.0',MAIN); self.assertEqual(PREV['release_name'],'Workspace Experience Consolidation')
