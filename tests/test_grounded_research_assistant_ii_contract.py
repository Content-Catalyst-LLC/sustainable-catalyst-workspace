...
class GroundedResearchAssistantII(unittest.TestCase):
 def test_01_lineage(self): self.assertEqual((MAN['version'],MAN['previous_version'],MAN['release_name']),('0.54.0','0.53.0','Shared Review & Research Handoff')); self.assertIn('Version: 0.54.0',MAIN); self.assertEqual(PREV['release_name'],'Workspace Experience Consolidation')
