...
class ResearchContractTests(unittest.TestCase):
    ...
    def test_project_embeds_research(self):
        s=json.loads((ROOT/'schemas/sc-workspace-project-v3.schema.json').read_text())
        self.assertEqual(s['properties']['schema']['const'],'sc-workspace-project/3.0'); self.assertIn('research',s['required'])
