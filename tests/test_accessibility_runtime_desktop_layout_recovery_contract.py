...
class HotfixContract(unittest.TestCase):
 def test_01_lineage_and_schema_stability(self):
  ...
  self.assertIn('Version: 0.66.0',MAIN);self.assertIn("SC_WORKSPACE_VERSION', '0.66.0",MAIN)
 ...
 def test_08_registry_hotfix(self):
  ...
  self.assertIn("BACKUP_KEY = 'sc_workspace_registry_backup_v0660'",REGPHP);self.assertIn('LEGACY_PENDING_KEY_V0640',REGPHP)
