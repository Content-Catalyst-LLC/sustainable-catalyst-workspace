...
def load():
    spec=importlib.util.spec_from_file_location('sc_uncertainty_service',ROOT/'backend'/'uncertainty-runtime'/'service.py'); mod=importlib.util.module_from_spec(spec); spec.loader.exec_module(mod); return mod
