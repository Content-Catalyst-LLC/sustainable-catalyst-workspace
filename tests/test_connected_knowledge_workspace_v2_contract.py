...
class ConnectedKnowledgeWorkspaceV2HistoricalContract(unittest.TestCase):
    def test_identity_and_lineage(self):
        ...
        self.assertIn("PREVIOUS_RELEASE = '2.0.2'",dep); self.assertIn("ROLLBACK_RELEASE = '2.0.2'",dep); self.assertIn("PREVIOUS_RELEASE = '2.0.2'",prod)
        self.assertIn('workspace-v2.0.3.js',dep); self.assertIn('workspace-v2.0.3.css',dep)
