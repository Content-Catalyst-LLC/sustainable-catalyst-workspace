...
$p=array('schema'=>'sc-workspace-project/14.0','id'=>'scwp-sync','title'=>'Sync Demo','updatedAt'=>'2026-08-09T00:00:00Z','persistence'=>array('mode'=>'device-local'),'recentTools'=>array('x'),'objects'=>array(array('id'=>'scwo-1','schema'=>'sc-workspace-object/1.0','title'=>'Evidence')));
...
echo "PASS - v0.33.0 cross-device sync runtime\n";
