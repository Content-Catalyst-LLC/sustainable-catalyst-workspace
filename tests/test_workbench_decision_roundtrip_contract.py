...
class WorkbenchDecisionRoundtrip(unittest.TestCase):
 ...
 def test_07_preserved_under_current(self): self.assertIn('Version: 1.8.0',MAIN);self.assertIn('buildContextPackage',APP);self.assertIn('toWorkspaceReturnPacket',APP)
