...
class WorkbenchDecisionRoundtrip(unittest.TestCase):
 ...
 def test_07_preserved_under_current(self): self.assertIn('Version: 2.0.2',MAIN);self.assertIn('buildContextPackage',APP);self.assertIn('toWorkspaceReturnPacket',APP)
