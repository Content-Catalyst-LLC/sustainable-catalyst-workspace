...
class CitationLibraryReferenceManagement(unittest.TestCase):
 ...
 def test_12_registry_history(self): self.assertEqual((REG['public_version'],REG['previous_version']),('0.46.0','0.45.0')); self.assertIn("BACKUP_KEY = 'sc_workspace_registry_backup_v0460'",REGPHP); self.assertIn('LEGACY_PENDING_KEY_V0430',REGPHP); self.assertTrue((ROOT/'history/release-manifest-v0.43.0.json').exists()); self.assertTrue((ROOT/'history/workspace-product-record-v0.43.0.json').exists())
