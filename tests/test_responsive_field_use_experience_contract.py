...
class T(unittest.TestCase):
 ...
 def test_06_asset_wiring(self):
  self.assertIn("'sc-workspace-field-use-v1'",PHP);self.assertIn("array('sc-workspace-browser-compatibility-v1', 'sc-workspace-accessibility-v1')",PHP);self.assertIn("'sc-workspace-v0770'",PHP);self.assertIn('workspace-v0.77.0.css',PHP);self.assertIn('workspace-v0.77.0.js',PHP);self.assertIn('SCWorkspaceFieldUse.boot(window)',APP)
