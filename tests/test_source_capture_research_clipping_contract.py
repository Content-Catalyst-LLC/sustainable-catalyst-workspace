...
class SourceCaptureResearchClippingContract(unittest.TestCase):
    ...
    def test_12_notebook_v2_preserves_capture_context(self):
        for token in ('sc-workspace-notebook-workspace/4.0','sc-workspace-notebook-block/3.0','blockFromCapture','citationLine','bibliography','capture'):
    ...
    def test_14_capture_adapter_public_helper(self):
        ...
        self.assertIn("'sc-workspace-research-notebook-v4'", PHP)
    ...
    def test_16_registry_and_history(self):
        ...
        self.assertIn('Notebook-to-Workspace Intelligence', REG['change_summary'])
