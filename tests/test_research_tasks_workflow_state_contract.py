...
class TestResearchTasksWorkflowState(unittest.TestCase):
 ...
 def test_11_registry(self): self.assertEqual((REG['public_version'],REG['previous_version']),('0.56.0','0.55.0'));self.assertIn("BACKUP_KEY = 'sc_workspace_registry_backup_v0560'",REGPHP);self.assertIn('LEGACY_PENDING_KEY_V0510',REGPHP)
