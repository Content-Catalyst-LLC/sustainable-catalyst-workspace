...
class ResearchNotebookContract(unittest.TestCase):
 ...
 def test_16_registry_and_plugin(self): self.assertEqual(REG['public_version'],'0.66.0'); self.assertEqual(REG['previous_version'],'0.65.0'); self.assertIn('Import, Export & Backward-Compatibility Hardening',REG['change_summary']); self.assertIn('Version: 0.66.0',MAIN); self.assertIn("BACKUP_KEY = 'sc_workspace_registry_backup_v0660'",REGPHP); self.assertIn('LEGACY_PENDING_KEY_V0320',REGPHP)
