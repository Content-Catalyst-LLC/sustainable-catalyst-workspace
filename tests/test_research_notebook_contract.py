...
class ResearchNotebookContract(unittest.TestCase):
 def test_01_lineage(self): self.assertEqual((MAN['version'],MAN['previous_version'],MAN['release_name']),('0.61.0','0.60.0','Product Hardening I: Browser, Recovery & Field-Use Resilience'))
 ...
 def test_16_registry_and_plugin(self): self.assertEqual(REG['public_version'],'0.61.0'); self.assertEqual(REG['previous_version'],'0.60.0'); self.assertIn('Product Hardening I',REG['change_summary']); self.assertIn('Version: 0.61.0',MAIN); self.assertIn("BACKUP_KEY = 'sc_workspace_registry_backup_v0610'",REGPHP); self.assertIn('LEGACY_PENDING_KEY_V0320',REGPHP)
