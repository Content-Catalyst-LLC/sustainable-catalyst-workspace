...
class ResearchNotebookContract(unittest.TestCase):
 def test_01_lineage(self): self.assertEqual((MAN['version'],MAN['previous_version'],MAN['release_name']),('0.46.0','0.45.0','Workspace Import & Interchange'))
 ...
 def test_16_registry_and_plugin(self): self.assertEqual(REG['public_version'],'0.46.0'); self.assertEqual(REG['previous_version'],'0.45.0'); self.assertIn('Workspace Import & Interchange',REG['change_summary']); self.assertIn('Version: 0.46.0',MAIN); self.assertIn("BACKUP_KEY = 'sc_workspace_registry_backup_v0460'",REGPHP); self.assertIn('LEGACY_PENDING_KEY_V0320',REGPHP)
