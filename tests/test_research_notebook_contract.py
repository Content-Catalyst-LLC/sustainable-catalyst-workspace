...
class ResearchNotebookContract(unittest.TestCase):
 def test_01_lineage(self): self.assertEqual((MAN['version'],MAN['previous_version'],MAN['release_name']),('0.56.0','0.55.0','Research Automation Framework'))
 ...
 def test_16_registry_and_plugin(self): self.assertEqual(REG['public_version'],'0.56.0'); self.assertEqual(REG['previous_version'],'0.55.0'); self.assertIn('Research Automation Framework',REG['change_summary']); self.assertIn('Version: 0.56.0',MAIN); self.assertIn("BACKUP_KEY = 'sc_workspace_registry_backup_v0560'",REGPHP); self.assertIn('LEGACY_PENDING_KEY_V0320',REGPHP)
