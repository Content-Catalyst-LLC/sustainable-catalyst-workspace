...
class TestInstitutionalResearchPackages(unittest.TestCase):
 def test_01_lineage(self): self.assertEqual((MAN['version'],MAN['previous_version'],MAN['release_name']),('0.57.0','0.56.0','Institutional Research Packages')); self.assertIn('Version: 0.64.1',MAIN)
 ...
 def test_13_registry_history(self): self.assertEqual((REG['public_version'],REG['previous_version']),('0.57.0','0.56.0')); self.assertIn("BACKUP_KEY = 'sc_workspace_registry_backup_v0641'",REGPHP); self.assertIn('LEGACY_PENDING_KEY_V0570',REGPHP); self.assertTrue((ROOT/'history/release-manifest-v0.56.0.json').exists())
