...
class TestResearchAutomationFramework(unittest.TestCase):
 def test_01_lineage(self): self.assertEqual((MAN['version'],MAN['previous_version'],MAN['release_name']),('0.56.0','0.55.0','Research Automation Framework')); self.assertIn('Version: 1.5.0',MAIN)
 ...
 def test_13_registry_history(self): self.assertEqual((REG['public_version'],REG['previous_version']),('0.66.0','0.65.0')); self.assertIn("BACKUP_KEY = 'sc_workspace_registry_backup_v150'",REGPHP); self.assertIn('LEGACY_PENDING_KEY_V0560',REGPHP); self.assertTrue((ROOT/'history/release-manifest-v0.56.0.json').exists())
