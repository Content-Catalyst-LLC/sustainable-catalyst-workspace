...
if(strpos($main,'Version: 2.0.3')===false||strpos($cards,'sc-workspace-work-mode-cards/2.0')===false||substr_count($class,'class="scw-work-mode-card"')!==4||strpos($class,"/work-mode-cards-contract")===false){fwrite(STDERR,"FAIL - v2.0.2 work-mode card runtime contract
