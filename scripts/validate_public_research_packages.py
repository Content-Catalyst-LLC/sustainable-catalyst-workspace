...
check('Version: 2.0.0' in MAIN and "SC_WORKSPACE_VERSION', '2.0.0'" in MAIN,'current WordPress identity')
...
check("PREVIOUS_RELEASE = '1.15.0'" in DEP and "ROLLBACK_RELEASE = '1.15.0'" in DEP and "PREVIOUS_RELEASE = '1.15.0'" in PROD,'current predecessor')
