...
check('Version: 1.15.0' in MAIN and "SC_WORKSPACE_VERSION', '1.15.0'" in MAIN,'current WordPress identity')
check("'/public-research-packages-contract'" in PHP and 'Public Research Packages &amp; Portable Knowledge Objects' in PHP and (P/'includes/class-sc-workspace-public-research-packages.php').is_file(),'historical surface')
check("PREVIOUS_RELEASE = '1.14.0'" in DEP and "ROLLBACK_RELEASE = '1.14.0'" in DEP and "PREVIOUS_RELEASE = '1.14.0'" in PROD,'current predecessor')
