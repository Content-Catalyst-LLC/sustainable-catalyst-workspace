...
check("PREVIOUS_RELEASE = '2.0.3'" in DEP and "ROLLBACK_RELEASE = '2.0.3'" in DEP and "PREVIOUS_RELEASE = '2.0.3'" in PROD,'current rollback lineage')
