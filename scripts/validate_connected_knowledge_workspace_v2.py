...
check("PREVIOUS_RELEASE = '2.0.2'" in DEP and "ROLLBACK_RELEASE = '2.0.2'" in DEP and "PREVIOUS_RELEASE = '2.0.2'" in PROD,'current rollback lineage')
