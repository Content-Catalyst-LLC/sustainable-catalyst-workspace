...
check('Version: 0.81.0' in MAIN and "SC_WORKSPACE_VERSION', '0.81.0" in MAIN,'current plugin version')
...
README=(R/'README.md').read_text(); check('# Sustainable Catalyst Workspace v0.81.0' in README and 'WordPress & Deployment Hardening' in README,'current README identity')
