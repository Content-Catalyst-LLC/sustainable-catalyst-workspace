...
for label,expected in [('Plugin Name','Sustainable Catalyst Workspace'),('Version','0.80.0'),('Author','Content Catalyst LLC'),('Requires at least','6.4'),('Requires PHP','8.0')]:
...
check("'sc-workspace-v0800'" in PHP and 'workspace-v0.80.0.js' in PHP and 'workspace-v0.80.0.css' in PHP,'current assets')
...
check("wp_localize_script('sc-workspace-v0800'" in PHP,'current localization handle')
...
check("BACKUP_KEY = 'sc_workspace_registry_backup_v0800'" in REGPHP and 'LEGACY_PENDING_KEY_V0790' in REGPHP,'registry keys')
...
README=(R/'README.md').read_text(); check('# Sustainable Catalyst Workspace v0.80.0' in README and 'Workspace Release Candidate I' in README,'current README identity')
