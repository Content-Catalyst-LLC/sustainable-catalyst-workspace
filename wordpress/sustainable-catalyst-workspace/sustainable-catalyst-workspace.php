...
define('SC_WORKSPACE_VERSION', '2.36.0');
...
require_once $sc_workspace_bootstrap_files['backend'];
...
function sc_workspace_activate() {
    ...
    if (empty($preflight['ok'])) {
        ...
        wp_die(esc_html('Sustainable Catalyst Workspace v2.36.0 activation preflight failed: ' . $reason));
    }
