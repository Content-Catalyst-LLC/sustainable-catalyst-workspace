 ...
 * Description: Free public research, evidence, analysis, decision, briefing, personal knowledge, inspectable knowledge graph, workflow and activity intelligence, asynchronous collaboration review, responsible AI assistance, interoperability, and portable project sharing workspace with traceable provenance and local-first persistence.
 * Version: 0.18.0
