 ...
 * Description: Free public research, evidence, analysis, decision, briefing, personal knowledge, inspectable knowledge graph, workflow intelligence, asynchronous review, institutional handoff, responsible AI assistance, interoperability, and portable sharing workspace with hardened local recovery, accessibility, diagnostics, release-readiness safeguards, and optional manual account recovery, conflict-safe cross-device synchronization, local project restore-point history, inspectable project change review, guided selective reconciliation into new project copies, and integrity-fingerprinted reconciliation decision receipts with explicit accepted/declined change provenance.
 * Version: 0.27.0
