...
function sc_workspace_activate() {
    ...
    if (empty($preflight['ok'])) {
        ...
        wp_die(esc_html('Sustainable Catalyst Workspace v1.10.0 activation preflight failed: ' . $reason));
    }
