...
function sc_workspace_activate() {
    ...
    if (empty($preflight['ok'])) {
        ...
        wp_die(esc_html('Sustainable Catalyst Workspace v0.82.1 activation preflight failed: ' . $reason));
    }
