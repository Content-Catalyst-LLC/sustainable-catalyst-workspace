...
define('SC_WORKSPACE_VERSION', '3.1.0');
...
function sc_workspace_activate() {
    ...
    if (empty($preflight['ok'])) {
        ...
        wp_die(esc_html('Sustainable Catalyst Workspace v3.0.0 activation preflight failed: ' . $reason));
    }
