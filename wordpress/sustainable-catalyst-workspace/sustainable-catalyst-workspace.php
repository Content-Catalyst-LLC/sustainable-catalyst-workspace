...
define('SC_WORKSPACE_VERSION', '2.14.0');
...
function sc_workspace_activate() {
    ...
    if (empty($preflight['ok'])) {
        ...
        wp_die(esc_html('Sustainable Catalyst Workspace v2.14.0 activation preflight failed: ' . $reason));
    }
