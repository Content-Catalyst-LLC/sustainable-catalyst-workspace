...
final class SC_Workspace_Deployment_Hardening {
    ...
    const PREVIOUS_RELEASE = '2.5.0';
    const ROLLBACK_RELEASE = '2.5.0';
    ...
    public static function required_files() {
        return array(
            ...
            'current_script' => 'assets/js/workspace-v2.6.0.js',
            'current_style' => 'assets/css/workspace-v2.6.0.css',
    ...
    public static function diagnostics() {
        ...
        return array(
            ...
            'expected_script' => 'workspace-v2.6.0.js',
            'expected_style' => 'workspace-v2.6.0.css',
