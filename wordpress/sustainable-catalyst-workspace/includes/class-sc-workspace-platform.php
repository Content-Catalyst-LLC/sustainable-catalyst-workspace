...
final class SC_Workspace_Platform {
    ...
    public function admin_notice() {
        ...
        echo '<div class="notice notice-info"><p><strong>Sustainable Catalyst Workspace v0.14.0:</strong> the dedicated Workspace page is ready. The Platform page is not changed automatically. <a href="' . esc_url($url) . '">Review the reversible Platform conversion</a>.</p></div>';
    }
    ...
    public function render_admin_page() {
        ...
        <div class="wrap">
            ...
            <p>v0.14.0 keeps <code>/platform/</code> as the stable route while presenting the product publicly as <strong>Workspace</strong>. Page conversion and navigation relabeling remain explicit administrator actions with rollback.</p>
