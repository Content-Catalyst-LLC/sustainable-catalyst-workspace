...
final class SC_Workspace_Platform {
    ...
    public function admin_notice() {
        ...
        echo '<div class="notice notice-info"><p><strong>Sustainable Catalyst Workspace v0.8.0:</strong> the dedicated Workspace page is ready. The Platform page is not changed automatically. <a href="' . esc_url($url) . '">Review the reversible Platform conversion</a>.</p></div>';
    }
    ...
    public function render_admin_page() {
        ...
        <div class="wrap">
            ...
            <p>v0.8.0 can preserve and manage the converted the existing <code>/platform/</code> page into the dedicated Sustainable Catalyst Workspace experience while preserving the page ID, slug, parent, publication state, and page template.</p>
