(() => {
  ...
  const PROJECT_SCHEMA = 'sc-workspace-project/18.0';
  ...
  const EXPORT_SCHEMA = 'sc-workspace-project-export/18.0';
  ...
  const NOTEBOOK_WORKSPACE_SCHEMA = 'sc-workspace-notebook-workspace/6.0';
  const NOTEBOOK_SCHEMA = 'sc-workspace-notebook/3.0';
  const NOTEBOOK_BLOCK_SCHEMA = 'sc-workspace-notebook-block/3.0';
  const NOTEBOOK_EXPORT_SCHEMA = 'sc-workspace-notebook-export/6.0';
