(() => {
  ...
  function init(root) {
    ...
    let integratedPrefs={query:'',kind:'all',subtype:'all',project:'all',tag:'',origin:'all',provenance:'all',scope:'active',sort:'relevance'}; let selectedIntegratedKey=''; let savedKnowledgeSearches=[];
