(function(){
  ...
  function init(){
    ...
    const q=s=>section.querySelector(s),deps=()=>({workspaceVersion:root.dataset.version||'0.70.0',persistence:window.SCWorkspacePersistenceIntegrity||null,compatibility:window.SCWorkspaceImportExportCompatibility||null,continuity:window.SCWorkspaceCrossDeviceContinuity||null});
    let last=null;
