(function(root,factory){
  ...
  const manualItems=Object.freeze([
    ...
    ['rollback','v1.3.0 rollback rehearsal','Replace v1.0.1 with the bundled v1.2.0 rollback plugin, verify the public shell and existing local project, then reinstall v1.0.1 and repeat the smoke.']
