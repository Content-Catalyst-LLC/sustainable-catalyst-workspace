(function(root,factory){
  ...
  const manualItems=Object.freeze([
    ...
    ['cache-coherence','WordPress/CDN/browser cache coherence','Verify the HTML, current cumulative JS, and current cumulative CSS all identify v1.8.0. If they do not, purge only page/asset caches—never Workspace project storage.'],
    ['rollback','v1.7.0 rollback rehearsal','Replace v1.8.0 with the bundled v1.7.0 rollback plugin, verify the public shell and existing local project, then reinstall v1.8.0 and repeat the smoke.']
