(function(root,factory){
  ...
  const manualItems=Object.freeze([
    ...
    ['rollback','v2.0.2 rollback rehearsal','Replace v2.0.3 with the bundled v2.0.2 rollback plugin, verify the public shell and existing local project, then reinstall v2.0.3 and repeat the smoke.']
