(function(root,factory){
  ...
  var ROUTES=[
    ...
    {id:'release-candidate',area:'review',label:'Release Candidate',description:'Run the RC gate, inspect the feature freeze, and keep field certification explicit.',keywords:'review release candidate rc feature freeze certification deployment rollback'},
    {id:'deployment',area:'review',label:'Deployment',description:'Verify WordPress package, current asset/version coherence, registry state, cache boundaries, and rollback readiness.',keywords:'review deployment wordpress plugin activation upgrade assets cache rollback mixed version'},
    {id:'production-certification',area:'review',label:'Production Certification',description:'Separate package-ready evidence from live production smoke, cache coherence, preservation, and rollback rehearsal.',keywords:'review production smoke cache rollback certification wordpress release candidate field validation'},
    {id:'production-signoff',area:'review',label:'Production Sign-Off',description:'Record explicit live-production field evidence before production release sign-off.'},
    {id:'ga-readiness',area:'review',label:'1.0 Readiness',description:'Close the production sign-off evidence loop and record an explicit human readiness decision for a future 1.0 release.'},
