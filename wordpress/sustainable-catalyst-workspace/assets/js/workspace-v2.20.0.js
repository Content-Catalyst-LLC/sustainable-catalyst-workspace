...
window.SCWorkspaceForecastingRuntime={version:'2.20.0',operations:['naive','seasonal-naive','linear-trend','exponential-smoothing','holt-winters','arima','backtest','evaluate'],arbitraryCodeExecution:false};

window.SCWorkspaceUncertaintyRuntime={version:'2.20.0',operations:['monte-carlo-weighted-sum','bootstrap-interval','latin-hypercube','correlated-normal','empirical-summary','rank-correlation-sensitivity','variance-contribution-linear','scenario-envelope'],arbitraryCodeExecution:false};
