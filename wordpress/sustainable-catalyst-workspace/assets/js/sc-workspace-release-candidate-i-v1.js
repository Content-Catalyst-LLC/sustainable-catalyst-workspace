(function(root,factory){
  ...
  const AUTOMATED_GATES=Object.freeze([
    ['release-identity','Release identity','The running Workspace must identify itself as the current v1.0.0 Release Candidate runtime.'],
  ...
  function assess(root,options={}){
    ...
    checks.push(finding('release-stage','Release Candidate stage',['release-candidate','general-availability'].includes(s.releaseStage),`Workspace stage is ${s.releaseStage||'unset'}; expected release-candidate or general-availability.`));
