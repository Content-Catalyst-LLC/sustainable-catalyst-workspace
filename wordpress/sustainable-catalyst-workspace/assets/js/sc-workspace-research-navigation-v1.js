(function(root,factory){
  ...
  const AREAS={
    start:{label:'Start',defaultView:'start',description:'Begin, resume, or follow the complete product journey.',views:['start','journey']},
    ...
    review:{label:'Review',defaultView:'activity',description:'Inspect activity, lifecycle, history, changes, safety, reconciliation, and audit records.',views:['activity','lifecycle','history','changes','reconcile','safety','audit','automation','performance','security','beta','reliability','integrity','compatibility','accessibility','recovery-drills']},
  ...
  const LABELS={start:'Start',journey:'Product Journey',projects:'Projects',research:'Research home',notebook:'Notebook',knowledge:'Knowledge',graph:'Graph',activity:'Activity',lifecycle:'Lifecycle',history:'History',changes:'Changes',reconcile:'Reconcile',safety:'Safety',audit:'Audit',automation:'Automation',performance:'Performance',security:'Security & Privacy',beta:'Beta Readiness',reliability:'Reliability',integrity:'Persistence Integrity',compatibility:'Compatibility',accessibility:'Accessibility','recovery-drills':'Recovery Drills',interoperability:'Import & Interoperability',collaboration:'Collaborate','api-embed':'API & Embed',institutional:'Institutional',share:'Share'};
