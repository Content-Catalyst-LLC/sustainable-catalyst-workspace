(function(root,factory){
  ...
  const AREAS={
    ...
    review:{label:'Review',defaultView:'activity',description:'Inspect activity, lifecycle, history, changes, safety, reconciliation, and audit records.',views:['activity','lifecycle','history','changes','reconcile','safety','audit','automation','performance','security','beta','reliability','integrity']},
  ...
  const LABELS={start:'Start',projects:'Projects',research:'Research home',notebook:'Notebook',knowledge:'Knowledge',graph:'Graph',activity:'Activity',lifecycle:'Lifecycle',history:'History',changes:'Changes',reconcile:'Reconcile',safety:'Safety',audit:'Audit',automation:'Automation',performance:'Performance',security:'Security & Privacy',beta:'Beta Readiness',reliability:'Reliability',integrity:'Persistence Integrity',interoperability:'Import & Interoperability',collaboration:'Collaborate','api-embed':'API & Embed',institutional:'Institutional',share:'Share'};
