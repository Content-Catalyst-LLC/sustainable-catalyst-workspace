(function(root,factory){
  ...
  const AREAS={
    ...
    review:{label:'Review',defaultView:'activity',description:'Inspect activity, lifecycle, history, changes, safety, reconciliation, and audit records.',views:['activity','lifecycle','history','changes','reconcile','safety','audit']},
    exchange:{label:'Exchange',defaultView:'interoperability',description:'Import, collaborate, hand off institutional work, and share portable copies.',views:['interoperability','collaboration','institutional','share']}
  };
  const LABELS={start:'Start',projects:'Projects',research:'Research home',notebook:'Notebook',knowledge:'Knowledge',graph:'Graph',activity:'Activity',lifecycle:'Lifecycle',history:'History',changes:'Changes',reconcile:'Reconcile',safety:'Safety',audit:'Audit',interoperability:'Import & Interoperability',collaboration:'Collaborate',institutional:'Institutional',share:'Share'};
