(function(root,factory){
  ...
  const AREAS={
    ...
    review:{label:'Review',defaultView:'activity',description:'Inspect activity, lifecycle, history, changes, safety, reconciliation, audit, release, recovery, and deployment records.',views:['activity','lifecycle','history','changes','reconcile','safety','audit','automation','performance','security','beta','reliability','integrity','compatibility','accessibility','final-audit','beta-closure','release-candidate','deployment','recovery-drills']},
