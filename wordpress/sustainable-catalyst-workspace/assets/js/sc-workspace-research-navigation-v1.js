(function(root,factory){
  ...
  const AREAS={
    start:{label:'Home',defaultView:'start',description:'Resume active work, orient a project, or move directly to the next task.',views:['start','journey','help']},
    ...
    review:{label:'Review',defaultView:'activity',description:'Inspect activity, lifecycle, history, changes, safety, reconciliation, audit, release, recovery, and deployment records.',views:['activity','lifecycle','history','changes','reconcile','safety','audit','automation','performance','security','beta','reliability','integrity','compatibility','accessibility','final-audit','beta-closure','release-candidate','deployment','production-certification','production-signoff','ga-readiness','general-availability','ga-stabilization','recovery-drills']},
