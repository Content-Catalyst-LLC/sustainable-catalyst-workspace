(function(root,factory){
  ...
  const checks=Object.freeze([
    ['root-version','Workspace runtime version','The rendered Workspace root must report the current v0.84.0 release.'],
    ...
    ['current-script','Current cumulative JavaScript','The page must load workspace-v0.84.0.js rather than an older cumulative shell.'],
    ['current-style','Current cumulative stylesheet','The page must load workspace-v0.84.0.css rather than an older cumulative stylesheet.'],
    ['asset-query','WordPress asset cache version','Current cumulative assets must carry the v0.84.0 WordPress version query when query strings are present.'],
  ...
  const manualItems=Object.freeze([
    ...
    ['rollback-rehearsal','v0.83.0 rollback rehearsal','Verify the bundled v0.82.1 WordPress rollback artifact can be restored and existing browser-local projects remain readable.']
