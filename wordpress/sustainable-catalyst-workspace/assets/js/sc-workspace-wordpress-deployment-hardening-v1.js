(function(root,factory){
  ...
  const manualItems=Object.freeze([
    ['upload-metadata','WordPress replacement metadata','Before replacement, verify WordPress shows Uploaded Version 1.8.0 and the expected author/requirements.'],
    ...
    ['rest-health','REST health identity','Verify /wp-json/sc-workspace/v1/health reports version 1.8.0 and the deployment-hardening contract is reachable.'],
    ...
    ['rollback-rehearsal','v1.7.0 rollback rehearsal','Verify the bundled v1.7.0 WordPress rollback artifact can be restored and existing browser-local projects remain readable.']
