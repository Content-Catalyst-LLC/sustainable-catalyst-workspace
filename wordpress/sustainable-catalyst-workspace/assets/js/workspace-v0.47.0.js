(() => {
  ...
  function buildKnowledgeGraph() {
    ...
    if(relationshipExplorer&&typeof relationshipExplorer.build==='function'){
      return relationshipExplorer.build(state,{references:Array.isArray(referenceLibrary?.references)?referenceLibrary.references:[],maxNodes:MAX_GRAPH_NODES,maxEdges:MAX_GRAPH_EDGES});
    }
