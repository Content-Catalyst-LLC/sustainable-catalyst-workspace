/* Workspace v2.36.0 thin-client state runtime. Canonical state is never persisted by this store. */
...
class WorkspaceThinClientStateStore {
  ...
  private readonly storageKey='sc_workspace_transient_v2310';
