/* Workspace v3.1.0 unified scientific object projection. Read-only generic discovery; mutations remain bounded domain APIs. */
...
const SCWorkspaceScientificObjectRuntime=Object.freeze({schema:'sc-workspace-scientific-object-client-runtime/1.0',version:'3.1.0',backendAuthoritative:true,browserAuthoritativeState:false,canonicalCachePersistent:false,genericMutation:false,create(api:WorkspaceTypedApiClient){return new WorkspaceScientificObjectStore(api);}});
